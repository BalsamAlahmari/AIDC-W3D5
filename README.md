...
The goal of this lab was to run the given benchmark harness against your locked model, sweep concurrency, find the knee where p95 crosses your target while throughput flattens, and write the one-page capacity note. Publish tokens/s and p95 to the progress board.
